...
def build_population_block(pref: dict) -> dict:
    ...
    return {
        "available": True,
        "population_scope_label": "人口（2020年国勢調査・日本人）",
        ...
        "summary_note": "日本人人口が対象です。実際の在学者数ではありません。",
        "notes": [
            "人口は、2020年10月1日現在の令和2年国勢調査による都道府県別日本人人口です。現在の人口ではありません。",
            "年齢別人口は、各校種に相当する年齢層の人口であり、実際の在学者数ではありません。就学猶予、留年、早生まれの学年境界、区域外通学、国私立校への進学、未就園、通信制などは反映していません。",
            "割合は、日本人人口を分母として計算しています。年齢「不詳」の人は含みません。",
        ],
        "source": {
