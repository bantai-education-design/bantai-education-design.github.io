...
for pref in prefectures:
    ...
    # Replace the load_mext_data block up to the loop
    # We will regex from def load_mext_data up to `for idx, row in active.iterrows():`
...
print("Applied load_mext_data fix for Gifu and Mie.")
