...
SHIMANE_CITIES = ['松江市', '浜田市', '出雲市', '益田市', '大田市', '安来市', '江津市', '雲南市']

SHIMANE_GUN_TOWNS = ['仁多郡奥出雲町', '飯石郡飯南町', '邑智郡川本町', '邑智郡美郷町', '邑智郡邑南町', '鹿足郡津和野町', '鹿足郡吉賀町', '隠岐郡海士町', '隠岐郡西ノ島町', '隠岐郡知夫村', '隠岐郡隠岐の島町']
...
def build_official_name(*, establishment: str, raw_name: str,
    ...
    # 例: 「山形市立商業高等学校」「島根県立致道館中学校」
    # 「島根県立村山特別支援学校山形校」（分校も含む）
