...
yamanashi_json = os.path.join(repo_root, "data", "school-database", "yamanashi.json")
ibaraki_json = os.path.join(repo_root, "data", "school-database", "ibaraki.json")
...
if __name__ == '__main__':
    ...
    y_tot, y_ver = validate_dataset(yamanashi_json, "Yamanashi Database")
    i_tot, i_ver = validate_dataset(ibaraki_json, "Ibaraki Database")

    print(f"\n[SUMMARY] Total Schools: {s_tot + t_tot + c_tot + k_tot + y_tot + i_tot}, Total Verified Official Websites: {s_ver + t_ver + c_ver + k_ver + y_ver + i_ver}")
