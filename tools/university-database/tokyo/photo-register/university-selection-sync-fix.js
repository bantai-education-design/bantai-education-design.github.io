...
(()=>{
  ...
  if(!document.querySelector('link[data-simple-register-flow]')){
    ...
    link.rel='stylesheet';
    link.href='simple-register-flow.css?v=20260825-0920';
  ...
  if(!document.querySelector('script[data-simple-register-flow]')){
    ...
    simple.src='simple-register-flow.js?v=20260825-0920';
    simple.defer=true;
  ...
  if(!document.querySelector('link[data-one-click-register]')){
    const link=document.createElement('link');
    link.rel='stylesheet';
    link.href='one-click-register.css?v=20260825-0920';
  ...
  if(!document.querySelector('script[data-one-click-register]')){
    ...
    one.src='one-click-register.js?v=20260825-0920';
    one.defer=true;
