...
function syncFromSelect(){if(document.activeElement!==input)input.value=selectedLabel();input.placeholder=list.querySelector('.batch-row')?'大学名・大学IDを入力して検索':'先に写真を入れてください';}
