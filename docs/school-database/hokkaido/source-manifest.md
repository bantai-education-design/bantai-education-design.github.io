...
公立小・中学校・義務教育学校・高等学校・中等教育学校は、原本の表記が「知新小」「岩見沢東」のような略称であることが多いため、設置者（市町村立/道立）＋校名＋校種から「旭川市立知新小学校」「北海道岩見沢東高等学校」のような正式名称を組み立てて収録しています。原本がすでに正式名称（例:「日高町立日高小学校」）の場合や、私立・国立・特別支援学校（別途正式名称で書き起こし済み）は組み立て処理の対象外です。
