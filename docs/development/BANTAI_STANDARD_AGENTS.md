...
This document is the canonical common policy for AI coding agents working on Ban.Tai Education Design projects. Repository-local `AGENTS.md` files may add stricter project-specific rules.
