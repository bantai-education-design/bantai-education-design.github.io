...
| **Commit 4** | 本コミット | `docs(admin): add GA4 specifications, operation guides and document validation test`<br>- `docs/admin/` 配下の仕様書・手順書の整備<br>- ドキュメント品質検証テスト `tools/check_docs_ga4.py` の追加 |
